...
namespace org.GraphDefined.Vanaheimr.Hermod.MCP
{
    ...
    internal static class Diagnostics
    {
        ...
        internal static ActivityContext ExtractActivityContext(this DistributedContextPropagator propagator, AJSONRPCMessage message)
        {
        ...
        internal static void InjectActivityContext(this DistributedContextPropagator propagator, Activity? activity, AJSONRPCMessage message)
        {
        ...
        internal static bool ShouldInstrumentMessage(AJSONRPCMessage message) =>
